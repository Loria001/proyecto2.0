...
class Program
{
...

    {
...

        {
            ...
            if (decimal.TryParse(Console.ReadLine(), out decimal montoPagaClienteInput))
            ...
            vuelto[indice] = montoPagar[indice] - montoPagaCliente[indice];
...

            {
                ...
                break; // Salir del bucle si los vectores están llenos
    ...
    static void ConsultarPagos()
    {
        ...
        if (int.TryParse(Console.ReadLine(), out numeroConsulta))
        {
            ...
            if (indiceConsulta != -1 && !pagoEliminado[indiceConsulta])
            {
                ...
                Console.WriteLine($"Número de Pago:       {numeroPago[indiceConsulta]}");

                Console.WriteLine($"Fecha y Hora:         {fecha[indiceConsulta]:yyyy-MM-dd}             Hora:          {hora[indiceConsulta]:hh\\:mm}");

                Console.WriteLine();

                Console.WriteLine($"Cédula:               {cedula[indiceConsulta]}                    Nombre:        {nombre[indiceConsulta]}");

                Console.WriteLine($"Apellido1:            {apellido1[indiceConsulta]}                   Apellido2:     {apellido2[indiceConsulta]}");

                Console.WriteLine();

                Console.WriteLine($"Número de Caja:       {numeroCaja[indiceConsulta]}");

                Console.WriteLine($"Tipo de Servicio:     {(tipoServicio[indiceConsulta])}             |1-Electricidad 2-Telefono 3-Agua");

                Console.WriteLine();

                Console.WriteLine($"Número de Factura:    {numeroFactura[indiceConsulta]}                   Monto A Pagar:  {montoPagar[indiceConsulta]}");

                Console.WriteLine($"Comision autorizada : {montoComision[indiceConsulta]}                 Paga con:       {montoPagaCliente[indiceConsulta]}");

                Console.WriteLine($"Monto Deducido  :     {montoDeducido[indiceConsulta]}                Vuelto:         {vuelto[indiceConsulta]}");
        ...
        {
            Console.WriteLine("Ingrese un número válido para consultar el pago.");
        }
        Console.ReadLine();
    }
    ...
    static void ModificarPagos()
    {
        ...
        int numeroModificar = int.Parse(Console.ReadLine());
    ...
    static void EliminarPagos()
    {
        ...
        if (indice != -1 && !pagoEliminado[indice])
        {
            ...
            if (respuesta == 'S' || respuesta == 's')
            {
                ...
                Console.WriteLine("La información fue eliminada con éxito.");
            }
            else
            {
        ...
        {
            Console.WriteLine("Pago no se encuentra registrado o ya fue eliminado.");
        }
    }
    ...
    static void ReportePagosPorTipoServicio()
    {
        ...
        int tipoServicioReporte = int.Parse(Console.ReadLine());
    ...
    static void ReportePagosPorCodigoCaja()
    {
        ...
        int codigoCajaReporte = int.Parse(Console.ReadLine());
        ...
        Console.BackgroundColor = ConsoleColor.DarkBlue;
        Console.Clear(); // Limpiar la pantalla antes de mostrar la información

        for (int i = 0; i < 10; i++)
        {
            if (!pagoEliminado[i] && numeroCaja[i] == codigoCajaReporte)
            {
                hayPagosRealizados = true;
                MostrarInformacionPago(i);
            }
